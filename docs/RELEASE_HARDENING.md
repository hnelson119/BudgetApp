...
- The maintained logging inventory now covers all 14 current stack layers and 169 source-derived
  ...
  budget-configuration, and occurrence-management submissions now emit minimized fixed events
