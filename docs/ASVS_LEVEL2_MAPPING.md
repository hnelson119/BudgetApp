...
| Implemented | 163 | A control and repeatable implementation evidence exist; release-candidate verification is pending. |
| Partial | 11 | Some relevant control or documentation exists, but the exact requirement remains incomplete or not fully exercised. |
...
These are the clearest implementation or operational work items exposed by the mapping. The 11
