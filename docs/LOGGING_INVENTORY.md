...
Rejected variable-budget creation, editing, deletion, and category-creation submissions use the
same fixed warning contract. Planned amounts, category names, notes, reasons, category or budget
references, version tokens, form errors, validation messages, and submitted values are excluded.
...
Rejected debt account creation and editing, terms revisions, statement reconciliation and
...
Rejected financial-account setup and notification-preference submissions use the same fixed
