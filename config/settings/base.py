...
INSTALLED_APPS = [
    "identity.apps.SecureAdminConfig",
    "django.contrib.auth",
...
MFA_ENCRYPTION_KEY_VERSION = int(os.getenv("DJANGO_MFA_ENCRYPTION_KEY_VERSION", "1"))
...
CSV_IMPORT_STAGING_RETENTION_HOURS = int(os.getenv("CSV_IMPORT_STAGING_RETENTION_HOURS", "24"))
